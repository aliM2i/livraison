...
calculate = function(){
    origin      = document.getElementById('ajouter_course_PdeRetrait').value; // Le point départ
    destination = document.getElementById('ajouter_course_PdeLivraison').value; // Le point d'arrivé
